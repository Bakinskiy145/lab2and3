 ...
 * 
 */
@WebServiceClient(name = "DisplayAssortment", targetNamespace = "http://asu.dgtu.donetsk.ua/ex/passexam", wsdlLocation = "http://localhost:8083/StoreSvcWeb/displayassortment?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8083/StoreSvcWeb/displayassortment?wsdl");
